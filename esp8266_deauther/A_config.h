...
// ===== DISPLAY ===== //
  ...
  #define DISPLAY_TEXT "HACKBUTT"
  #define BLING_TEXT "HACKBUTT"
  #define MAKER_TEXT "by rot13labs"
...
// ===== AP ===== //
  #define AP_SSID "hackbutt"
  #define AP_PASSWD "rot13labs"
